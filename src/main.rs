...
pub const PLAYER_SIZE: f32 = 64.0;      // Size of the player sprite
...
pub fn update_enemy_direction(
    ...
    for (transform, mut enemy) in enemy_query.iter_mut() {
        ...
        if direction_changed {
            ...
            // Randomly select one of the sound effects
...
pub fn tick_star_spawn_timer(
    ...
    star_spawn_timer.timer.tick(timer.delta());
}
...
pub fn tick_enemy_spawn_timer(
    ...
    enemy_spawn_timer.timer.tick(timer.delta());
}
...
pub fn update_high_scores(
    ...
    for event in game_over_event_reader.iter() {
        high_scores.scores.push((String::from("Bob"), event.score));
    }
}
